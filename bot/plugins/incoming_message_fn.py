        ...
        try:
            ...
            if user.status == "kicked":
               await bot.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Deployer](https://t.me/shinukat).",
                   parse_mode="markdown",
            ...
            await bot.send_message(
                chat_id=update.chat.id,
                text="Something went Wrong. Contact my [Deployer](https://t.me/shinukat).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Movie Channel', url='https://t.me/katmovieshd1')
                ],
                [
                    InlineKeyboardButton('Deployer', url='https://t.me/shinukat')
                ]
            ]
        ),
